    ...
    <div class="reservation">
        ...
        @csrf
            <div class="mb-3">
                ...
                <input type="text" class="reservation-form" name="inputFullName" id="inputFullName" placeholder="" required>
            </div>
            <div class="mb-3">
                <label for="inputEmail" class="form-label">E-mail :</label>
                <input type="email" class="reservation-form" name="inputEmail" id="inputEmail" placeholder="youremail@email.com" required>
            </div>
            <div class="mb-3">
                <label for="inputNumber" class="form-label">Phone Number :</label>
                <input type="text" class="reservation-form" name="inputNumber" id="inputNumber" placeholder="08xxxxxxxxxx" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="inputHospital" class="form-label">Hospital :</label>
                    <input type="text" class="reservation-form" name="inputHospital" id="inputHospital" value="{{$hospitals['namarumahsakit']}}">
            </div>
            <div class="mb-3">
